...
import tools.jackson.datatype.javax.money.MonetaryAmountDeserializer;
import tools.jackson.datatype.javax.money.MonetaryAmountFactory;
 ...
 */
@API(status = STABLE)
public final class MonetaMoneyModule extends JacksonModule
{
