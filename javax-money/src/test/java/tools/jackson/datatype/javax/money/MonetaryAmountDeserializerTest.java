...
public final class MonetaryAmountDeserializerTest<M extends MonetaryAmount> {
    ...
    public void shouldFailToDeserializeWithAdditionalProperties(
        ...
        final UnrecognizedPropertyException exception = assertThrows(
    ...
    @Test
    public void shouldDeserializeToAMonetaImplementationWithProvidedFactory() throws Exception {

        //Custom FastMoney factory that returns zero
        final ObjectMapper unit = JsonMapper.builder()
                .addModule(new JavaxMoneyModule().withMonetaryAmountFactory((number, currency) -> (FastMoney.zero(currency))))
                .build();
